...
if(isset($_POST['json'])){
	...
	if($data['get'] === 'playerdata'){
		$sql = 'SELECT t1.`player_uid`, t1.`char_name`, t1.`guild_id`, t3.`name_de`, t2.`name_de`, t2.`map_id`, t1.`pos_x`, t1.`pos_y`, t1.`pos_angle`, t1.`pos_time`, t2.`map_rect`, t2.`continent_rect`
		...
		mysqli_stmt_bind_result($stmt, $uid, $charname, $guild, $world, $map, $map_id, $pos_x, $pos_y, $pos_b, $time, $mr, $cr);
		...
		while(mysqli_stmt_fetch($stmt)){
			$arr[$uid] = [
				...
				'angle' => round($pos_b < 0 ? 360 + $pos_b : $pos_b, 2),
