...
$.ajax({url:"https://api.guildwars2.com/v1/map_floor.json?continent_id="+b.continent_id+"&floor="+b.floor_id+"&lang="+b.i18n.lang,dataType:"json",success:function(d){$.ajax({url:"https://api.guildwars2.com/v1/event_details.json?lang="+b.i18n.lang,dataType:"json",success:function(e){var c={};$.each(e.events,function(a,b){"undefined"===typeof c[b.map_id]&&(c[b.map_id]={});c[b.map_id][a]=b});GW2Maps.parse_response(a,b,d,c)}}).fail(function(){console.log(this)})}}).fail(function(d,e,c){b.region_id=!1;
GW2Maps.parse_response(a,b,{texture_dims:1===b.continent_id?[32768,32768]:[16384,16384],regions:[]},{});console.log(d);console.log(e);console.log(c);a.linkbox.append(this.toString())});return a},parse_response:function(g,b,a,d){var f,h,l=function(a){return g.map.unproject(a,b.max_zoom)};a.clamped_view?(f=a.clamped_view,f=(new L.LatLngBounds(l([f[0][0],f[1][1]]),l([f[1][0],f[0][1]]))).pad(0.2)):b.region_id&&b.map_id?(f=a.regions[b.region_id].maps[b.map_id].continent_rect,f=(new L.LatLngBounds(l([f[0][0],
f[1][1]]),l([f[1][0],f[0][1]]))).pad(0.4)):f=(new L.LatLngBounds(l([0,a.texture_dims[1]]),l([a.texture_dims[0],0]))).pad(0.1);g.map.setMaxBounds(f).fitBounds(f);b.region_id&&b.map_id?(h="undefined"!==typeof d[b.map_id]?d[b.map_id]:!1,GW2Maps.parse_map(g,b,a.regions[b.region_id].maps[b.map_id],h)):$.each(a.regions,function(){$.each(this.maps,function(a){h="undefined"!==typeof d[a]?d[a]:!1;GW2Maps.parse_map(g,b,this,h)})})},parse_map:function(g,b,a,d){var f={task:[],event:[],landmark:[],skill:[],vista:[],
waypoint:[],sector:[]},h={task:[],event:[],landmark:[],skill:[],vista:[],waypoint:[],sector:[]};$.each(a.points_of_interest,function(){"waypoint"==this.type&&(h.waypoint.push(this.name),f.waypoint.push({id:this.poi_id,type:this.type,coords:this.coord,title:this.name,text:this.name,popup:this.name+"<br />id:"+this.poi_id}));"landmark"==this.type&&(h.landmark.push(this.name),f.landmark.push({id:this.poi_id,type:this.type,coords:this.coord,title:this.name,text:this.name,popup:'<a href="'+b.i18n.wiki+
encodeURIComponent(this.name)+'" target="_blank">'+this.name+"</a><br />id:"+this.poi_id}));"vista"==this.type&&(h.vista.push(this.poi_id),f.vista.push({type:this.type,coords:this.coord,title:"id:"+this.poi_id,text:this.name+" "+this.poi_id,popup:"id:"+this.poi_id}))});$.each(a.tasks,function(){h.task.push(this.level);f.task.push({id:this.task_id,type:"task",coords:this.coord,title:this.objective+" ("+this.level+")",text:"("+this.level+") "+this.objective,popup:'<a href="'+b.i18n.wiki+encodeURIComponent(this.objective.replace(/\.$/,
""))+'" target="_blank">'+this.objective+"</a> ("+this.level+")<br />id:"+this.task_id})});$.each(a.skill_challenges,function(){h.skill.push(this.coord.toString());f.skill.push({id:null,type:"skill",coords:this.coord,title:this.coord.toString(),text:this.name+" "+this.coord.toString(),popup:this.name+" "+this.coord.toString()})});$.each(a.sectors,function(){h.sector.push(this.name);f.sector.push({id:this.sector_id,type:"sector",coords:this.coord,title:this.name+", id:"+this.sector_id,icon_text:this.name,
icon_text_class:"sector_text",text:this.name,popup:!1})});d&&$.each(d,function(d){h.event.push(this.level);f.event.push({id:d,type:"event",coords:[a.continent_rect[0][0]+(a.continent_rect[1][0]-a.continent_rect[0][0])*(this.location.center[0]-a.map_rect[0][0])/(a.map_rect[1][0]-a.map_rect[0][0]),a.continent_rect[0][1]+(a.continent_rect[1][1]-a.continent_rect[0][1])*(1-(this.location.center[1]-a.map_rect[0][1])/(a.map_rect[1][1]-a.map_rect[0][1]))],title:this.name+" ("+this.level+")",text:"("+this.level+
") "+this.name,popup:'<a href="'+b.i18n.wiki+encodeURIComponent(this.name.replace(/\.$/,""))+'" target="_blank">'+this.name+"</a> ("+this.level+")<br />id:"+d})});g.linkbox.append('<div class="header">'+a.name+"</div>");$.each(f,function(a,d){phpjs.array_multisort(h[a],"SORT_ASC",d);0<d.length&&(g.linkbox.append('<div class="header sub">'+b.i18n[a]+"</div>"),$.each(d,function(){GW2Maps.parse_point(g,b,this)}))})},parse_point:function(g,b,a){var d=function(a){var d=g.map.unproject(a.data.coords,b.max_zoom);
g.map.panTo(d);a.data.text&&L.popup({offset:new L.Point(0,-5)}).setLatLng(d).setContent(a.data.text).openOn(g.map)},f=b.i18n["icon_"+a.type],h;h="sector"===a.type?L.divIcon({className:a.icon_text_class,html:a.icon_text}):L.icon({iconUrl:f.link,iconSize:f.size,popupAnchor:[0,-f.size[1]/2]});h=L.marker(g.map.unproject(a.coords,b.max_zoom),{title:a.title,icon:h});a.popup&&h.bindPopup(a.popup);g.layers[b.i18n[a.type]].addLayer(h);g.linkbox.append($("<div>"+(f?'<img src="'+f.link+'" style="width:16px; height:16px" />':
"")+" "+a.text+"</div>").on("click",null,{coords:a.coords,text:a.popup},d));b.poi_id&&(a.id===b.poi_id&&b.poi_type&&a.type===b.poi_type)&&(d({data:{coords:a.coords,text:a.popup}}),g.map.setZoom(b.max_zoom))},parse_polylines:function(g,b){var a=b.polyline.split(";");$.each(a,function(){var a=this.split(" "),f=[],h={};$.each(a,function(a,c){if(c.match(/\d{1,5},\d{1,5}/)){var d=c.split(",");f.push(g.map.unproject(d,b.max_zoom))}c.match(/(color|width|opacity|style|type)=(([0-9a-f]{3}){1,2}|\d{1,3}|(arrow|marker|dash))/i)&&
(d=c.toLowerCase().split("="),h[d[0]]=d[1])});var a="undefined"!==typeof h.color?"#"+h.color:"#ffe500",l="undefined"!==typeof h.width?phpjs.intval(h.width):3,e="undefined"!==typeof h.opacity?phpjs.intval(h.opacity)/100:0.8,f=L.polyline(f,{color:a,weight:l,opacity:e,dashArray:"dash"===h.style?"30,15,10,15":""});g.layers[b.i18n.polyline].addLayer(f);if("undefined"!==typeof h.type){var c=[];"arrow"===h.type&&c.push({offset:50,repeat:"150px",symbol:new L.Symbol.ArrowHead({pixelSize:15,polygon:!1,pathOptions:{stroke:!0,
color:a,weight:l,opacity:e}})});"marker"===h.type&&c.push({offset:0,repeat:"100%",symbol:new L.Symbol.Marker});g.layers[b.i18n.polyline].addLayer(L.polylineDecorator(f,{patterns:c}))}})},options:function(g){var b={};$.each(g.attributes,function(){this.name.match(/^data-/)&&(b[this.name.substr(5)]="data-polyline"===this.name?this.value:phpjs.intval(this.value))});g=["en","de","en","es","fr"];var a=[!1,"landmark","sector","skill","task","vista","waypoint"],d="number"===typeof b.continent_id&&1<=b.continent_id&&
...
0<b.height?b.height+(!0==b.h_percent?"%":"px"):"450px",map_controls:!0!=b.disable_controls,linkbox:"number"===typeof b.linkbox&&100<=b.linkbox?b.linkbox+"px":!1,polyline:b.polyline&&7<b.polyline.length?b.polyline:!1,i18n:"number"===typeof b.language&&1<=b.language&&4>=b.language?GW2Maps.i18n[g[b.language]]:GW2Maps.i18n[g[0]]}},i18n:{de:{lang:"de",wiki:"http://wiki-de.guildwars2.com/wiki/",icon_event:{link:"http://wiki-de.guildwars2.com/images/7/7a/Event_Angriff_Icon.png",size:[24,24]},icon_landmark:{link:"http://wiki-de.guildwars2.com/images/0/0f/Sehensw\u00fcrdigkeit_Icon.png",
...
landmark:"Sites remarquables",polyline:"polyline-fr",sector:"Secteurs",skill:"D\u00e9fis de comp\u00e9tences",task:"C\u0153urs",vista:"Panoramas",waypoint:"Points de passage",attribution:"attribution-fr"}}},phpjs={intval:function(g,b){var a;a=typeof g;return"boolean"===a?+g:"string"===a?(a=parseInt(g,b||10),isNaN(a)||!isFinite(a)?0:a):"number"===a&&isFinite(g)?g|0:0},array_multisort:function(g){var b={SORT_REGULAR:16,SORT_NUMERIC:17,SORT_STRING:18,SORT_ASC:32,SORT_DESC:40},a=0,d=[[]],f=[[]],h=[0],
...
typeof arguments[c]){n=h.pop();if("undefined"===typeof b[arguments[c]]||0<(b[arguments[c]]>>>4&n>>>4))return!1;h.push(n+b[arguments[c]])}else return!1;for(e=0;e!==a;e++)t.push(!0);for(e in d)if(d.hasOwnProperty(e)){n=[];m=[];p=0;r=[];q=[];if(0===k.length)if("[object Array]"===Object.prototype.toString.call(arguments[e]))arguments[e]=d[e];else{for(s in arguments[e])arguments[e].hasOwnProperty(s)&&delete arguments[e][s];a=d[e].length;for(n=c=0;c<a;c++)n=f[e][c],arguments[e][n]=d[e][c]}else{b=v[h[e]&
