	...
	$$(".gw2map").each(function(e){
		...
		// TODO: i18n
			professions = {
				...
				1: {name: "Engineer", icon: "http://wiki-de.guildwars2.com/images/c/c9/Ingenieur_Icon.png"},
				2: {name: "Necromancer", icon: "http://wiki-de.guildwars2.com/images/2/23/Nekromant_Icon.png"},
				3: {name: "Thief", icon: "http://wiki-de.guildwars2.com/images/0/07/Dieb_Icon.png"},
				4: {name: "Elementalist", icon: "http://wiki-de.guildwars2.com/images/b/b4/Elementarmagier_Icon.png"},
				5: {name: "Warrior", icon: "http://wiki-de.guildwars2.com/images/9/90/Krieger_Icon.png"},
				6: {name: "Ranger", icon: "http://wiki-de.guildwars2.com/images/5/5e/Waldläufer_Icon.png"},
				7: {name: "Mesmer", icon: "http://wiki-de.guildwars2.com/images/0/05/Mesmer_Icon.png"},
				8: {name: "Guardian", icon: "http://wiki-de.guildwars2.com/images/f/f4/Wächter_Icon.png"}
			};
								...
								popup = new Element("table").insert(
										new Element("tr").insert(
												new Element("td", {"style":"width: 44px; text-align: center;"}).update(
													new Element("img", {"src": professions[p.value.profession].icon, "alt": professions[p.value.profession].name, "style": "width:32px; height: 32px;"})
												)
											).insert(
