...
(0, 'eu', '-', '-', '-', '-'),
(1001, 'us', 'Amboss-Stein', 'Anvil Rock', 'Roca del Yunque', 'Rocher de l''enclume'),
(1002, 'us', 'Borlis-Pass', 'Borlis Pass', 'Paso de Borlis', 'Passage de Borlis'),
(1003, 'us', 'Yakbiegung', 'Yak''s Bend', 'Declive del Yak', 'Courbe du Yak'),
(1004, 'us', 'Steinkreis von Denravi', 'Henge of Denravi', 'Círculo de Denravi', 'Cromlech de Denravi'),
(1005, 'us', 'Maguuma', 'Maguuma', 'Maguuma', 'Maguuma'),
(1006, 'us', 'Hochofen der Betrübnis', 'Sorrow''s Furnace', 'Fragua del Pesar', 'Fourneau des lamentations'),
(1007, 'us', 'Tor des Wahnsinns', 'Gate of Madness', 'Puerta de la Locura', 'Porte de la folie'),
...
(1016, 'us', 'Meer des Leids', 'Sea of Sorrows', 'Mar de los Pesares', 'Mer des lamentations'),
...
(1023, 'us', 'Devonas Ruh', 'Devona''s Rest', 'Descanso de Devona', 'Repos de Devona'),
(1024, 'us', 'Eredon-Terrasse', 'Eredon Terrace', 'Terraza de Eredon', 'Plateau d''Eredon'),
(2001, 'eu', 'Riss des Kummers', 'Fissure of Woe', 'Fisura de la Aflicción', 'Fissure du malheur'),
(2002, 'eu', 'Ödnis', 'Desolation', 'Desolación', 'Désolation'),
(2003, 'eu', 'Gandara', 'Gandara', 'Gandara', 'Gandara'),
(2004, 'eu', 'Schwarzwasser', 'Blacktide', 'Marea Negra', 'Noirflot'),
...
(2010, 'eu', 'Seemannsruh', 'Seafarer''s Rest', 'Refugio del Viajante', 'Repos du Marin'),
(2011, 'eu', 'Vaabi', 'Vabbi', 'Vabbi', 'Vabbi'),
(2012, 'eu', 'Piken-Platz', 'Piken Square', 'Plaza de Piken', 'Place Piken'),
(2013, 'eu', 'Auroralichtung', 'Aurora Glade', 'Claro de la Aurora', 'Clairière de l''aurore'),
...
(2103, 'fr', 'Fels der Weissagung [FR]', 'Augury Rock [FR]', 'Roca del Augurio [FR]', 'Roche de l''Augure [FR]'),
(2104, 'fr', 'Vizunah-Platz [FR]', 'Vizunah Square [FR]', 'Plaza de Vizunah [FR]', 'Place de Vizunah [FR]'),
(2105, 'fr', 'Arborstein [FR]', 'Arborstone [FR]', 'Piedra Arbórea [FR]', 'Pierre Arborea [FR]'),
(2201, 'de', 'Kodasch [DE]', 'Kodash [DE]', 'Kodash [DE]', 'Kodash [DE]'),
(2202, 'de', 'Flussufer [DE]', 'Riverside [DE]', 'Ribera [DE]', 'Provinces fluviales [DE]'),
(2203, 'de', 'Elonaspitze [DE]', 'Elona Reach [DE]', 'Cañón de Elona [DE]', 'Bief d''Elona [DE]'),
(2204, 'de', 'Abaddons Maul [DE]', 'Abaddon''s Mouth [DE]', 'Boca de Abaddon [DE]', 'Bouche d''Abaddon [DE]'),
...
(2301, 'es', 'Baruch-Bucht [ES]', 'Baruch Bay [SP]', 'Bahía de Baruch [ES]', 'Baie de Baruch [SP]');
